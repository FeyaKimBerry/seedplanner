...
const STR = {
  en: {
    ...
    tab_plans: "Goals", title_plans: "Goals", sub_plans: "Things you're saving toward or spending on — each one appears on your projection.",
  ...
  th: {
    ...
    tab_plans: "เป้าหมาย", title_plans: "เป้าหมาย", sub_plans: "สิ่งที่คุณกำลังออมหรือจะใช้จ่าย — แต่ละรายการจะแสดงในการคาดการณ์",
  ...
  de: {
    ...
    tab_plans: "Ziele", title_plans: "Ziele", sub_plans: "Dinge, auf die du sparst oder die du ausgeben wirst — jedes erscheint in deiner Prognose.",
  ...
  fr: {
    ...
    tab_plans: "Objectifs", title_plans: "Objectifs", sub_plans: "Ce pour quoi vous épargnez ou dépenserez — chaque élément apparaît dans votre projection.",
